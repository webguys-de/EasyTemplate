...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('easytemplate/template_data_varchar', array('field')),
        array('field'))
    ->addForeignKey($installer->getFkName('easytemplate/template_data_varchar', 'template_id', 'easytemplate/template', 'id'),
        'template_id', $installer->getTable('easytemplate/template'), 'id',
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('easytemplate/template_data_text', array('field')),
        array('field'))
    ->addForeignKey($installer->getFkName('easytemplate/template_data_text', 'template_id', 'easytemplate/template', 'id'),
        'template_id', $installer->getTable('easytemplate/template'), 'id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('easytemplate/template_data_int', array('field')),
        array('field'))
    ->addForeignKey($installer->getFkName('easytemplate/template_data_int', 'template_id', 'easytemplate/template', 'id'),
        'template_id', $installer->getTable('easytemplate/template'), 'id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('easytemplate/template_data_datetime', array('field')),
        array('field'))
    ->addForeignKey($installer->getFkName('easytemplate/template_data_datetime', 'template_id', 'easytemplate/template', 'id'),
        'template_id', $installer->getTable('easytemplate/template'), 'id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('easytemplate/template_data_decimal', array('field')),
        array('field'))
    ->addForeignKey($installer->getFkName('easytemplate/template_data_decimal', 'template_id', 'easytemplate/template', 'id'),
        'template_id', $installer->getTable('easytemplate/template'), 'id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
